...
uint32_t getcolor(float lum)
{
	...
	case 16: col = 0x6c6c6cff; break;
	case 17: col = 0x7a7a7aff; break;
	case 18: col = 0x8b8b8bff; break;
	case 19: col = 0xabababff; break;
	case 20: col = 0xcacacaff; break;
	case 21: col = 0xcdcdcdff; break;
	case 22: col = 0xdadadaff; break;
